...
public class BinarySearchTreeMap<K extends Comparable<K>, V> extends AbstractOrderedMap<K, V> {
    ...
    /** The BalanceableBinaryTree class is an inner class below and this a variable to hold the tree */
    ...
    protected static class BalanceableBinaryTree<K, V> extends LinkedBinaryTree<Entry<K, V>> {
         ...
         *                      (true) or not (false)
         */
        private void relink(BinaryTreeNode<Entry<K, V>> parent, BinaryTreeNode<Entry<K, V>> child, boolean makeLeftChild) {
        ...
        public void rotate(Position<Entry<K, V>> p) {
        	...
        	if(grandpa == null) {
        		...
        		relink(grandpa, node, parent == grandpa.getLeft());
        	}
        ...
        public Position<Entry<K, V>> restructure(Position<Entry<K, V>> x) {
        	...
        	if(((left(parent) == x) && (left(grandparent) == parent)) || ((right(parent) == x) && 
        		...
        		//rotate node around the parent twice
        		rotate(x);
        		rotate(x);
        		return x;
        	}
    ...
    /**
     * Finds sibling of anode
     * @param p position
     * @return position sibling of p
     */
