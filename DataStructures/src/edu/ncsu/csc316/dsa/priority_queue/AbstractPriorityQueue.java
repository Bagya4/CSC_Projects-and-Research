...
public abstract class AbstractPriorityQueue<K extends Comparable<K>, V> implements PriorityQueue<K, V> {
     ...
     *
     * @param c to compare the custom Comparator to use when comparing keys (priorities)
     */
    ...
    public class NaturalOrder implements Comparator<K> {
    	/**
    	 * inner class to compare
    	 * @param first element
    	 * @param second element
    	 * @return an int of value 0, 1, or -1
    	 */
     ...
     *
     * @param data1 key1 a key to compare
     * @param data2 key2 a key to compare
