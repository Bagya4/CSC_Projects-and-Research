	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == itemClear) { 
			if (manager.isChanged()) {
				int select = JOptionPane.showConfirmDialog(null, "Test plans are unsaved. Would you like to save before cleaning?", "Warning", JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
				if (select == 1) {
